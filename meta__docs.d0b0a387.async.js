...
`},68469:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},7339:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},85057:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},99152:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},49351:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},90048:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},11100:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},7592:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},42461:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},39365:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},17106:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},97706:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},52223:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},188:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},27084:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},3091:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
import { Schema } from '@formily/react';
...
`},76365:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},30366:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},22069:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},75240:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
...
`},22798:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { useMemo } from 'react';
import { createForm } from '@formily/core';
import { Form, FormButtonGroup, Reset, Submit } from '@formily/antd-v5';
import { SchemaField } from '../common/SchemaField';
...
`},10951:function(p,n){n.Z=`import { type Option } from './types';
import { mockApiBaseURL } from '@site/constant/index';
...
`},70957:function(p,n){n.Z=`import { type ISchema } from '@formily/react';
import { SchemaForm } from '../common/SchemaForm';
...
`},22547:function(p,n,e){e.r(n),e.d(n,{Lifecycle:function(){return u},default:function(){return d}});var o=e(29068),m=Object.defineProperty,s=Object.getOwnPropertySymbols,R=Object.prototype.hasOwnProperty,h=Object.prototype.propertyIsEnumerable,r=(t,a,l)=>a in t?m(t,a,{enumerable:!0,configurable:!0,writable:!0,value:l}):t[a]=l,A=(t,a)=>{for(var l in a||(a={}))R.call(a,l)&&r(t,l,a[l]);if(s)for(var l of s(a))h.call(a,l)&&r(t,l,a[l]);return t},x=(t,a)=>{var l={};for(var c in t)R.call(t,c)&&a.indexOf(c)<0&&(l[c]=t[c]);if(t!=null&&s)for(var c of s(t))a.indexOf(c)<0&&h.call(t,c)&&(l[c]=t[c]);return l},g=(t,a,l)=>(r(t,typeof a!="symbol"?a+"":a,l),l),E=(t,a,l)=>new Promise((c,f)=>{var C=N=>{try{T(l.next(N))}catch(L){f(L)}},F=N=>{try{T(l.throw(N))}catch(L){f(L)}},T=N=>N.done?c(N.value):Promise.resolve(N.value).then(C,F);T((l=l.apply(t,a)).next())});const v=t=>Object.prototype.toString.call(t).slice(8,-1),D=t=>v(t)==="Object",_=t=>t instanceof Error?t.message:t instanceof Response?`http error: ${t.statusText}, Status: ${t.status}`:"unknown error",P=(t,a)=>{try{return JSON.stringify(t,(l,c)=>typeof c=="function"?`${c}`:typeof c=="undefined"?"undefined":c)}catch(l){return a||`JSON.stringify error: ${_(l)}`}},M=(t,a)=>{const[l,c]=t.split("?"),f=new URLSearchParams(c);D(a)&&Object.entries(a).forEach(([F,T])=>{typeof T=="undefined"||T===null||(f.has(F)?f.set(F,T):f.append(F,T))});const C=f.toString();return C?[l,C].join("?"):l},O=t=>E(void 0,null,function*(){try{const a=t,{url:l,baseURL:c="",params:f}=a,C=x(a,["url","baseURL","params"]),F=C.method||"GET";if(typeof l!="string"||!l)throw new TypeError("url\u5B57\u6BB5\u4E0D\u80FD\u4E3A\u7A7A\u4E14\u5FC5\u987B\u662F\u5B57\u7B26\u4E32\u7C7B\u578B");let T=/^http(s?):\/\//i.test(l)?l:c+l;F.toUpperCase()==="GET"?T=M(T,f):C.body=P(f,"{}");const N=yield fetch(T,A({headers:{"Content-Type":"application/json"}},C));if(!N.ok)throw N;return N.json()}catch(a){const l=_(a);throw new Error(`fetch error, ${l}`,{cause:a})}}),U=t=>{if(!t)return{};if(typeof t!="object")throw new TypeError("\u53C2\u6570\u7C7B\u578B\u9519\u8BEF,\u9700\u8981\u4E3A\u5BF9\u8C61");return t},S=(t,a,l)=>{const c=t[a]||[];return t[a]=[l,...Array.isArray(c)?c:[c]],t};class y{constructor(a,l="FormilyRequest",c){g(this,"debug"),g(this,"prefix"),g(this,"onLog"),this.debug=a,this.prefix=l,this.onLog=c}formatMessage(a,l,c){let f=`[${new Date().toLocaleString()}][${this.prefix}][${a}]:${l} `;return c!==void 0&&(f+=P(c)),f}info(a,l){var c;const f=this.formatMessage("INFO",a,l);(c=this.onLog)==null||c.call(this,"INFO",f),this.debug&&console.info(f)}warn(a,l){var c;const f=this.formatMessage("WARN",a,l);(c=this.onLog)==null||c.call(this,"WARN",f),this.debug&&console.warn(f)}error(a,l){var c;const f=this.formatMessage("ERROR",a);(c=this.onLog)==null||c.call(this,"ERROR",f,l),this.debug&&console.error(f,l)}group(a){this.debug&&console.group(this.formatMessage("GROUP",a))}groupEnd(){this.debug&&console.groupEnd()}}var u=(t=>(t[t.UNMOUNT=0]="UNMOUNT",t[t.INIT=1]="INIT",t[t.MOUNTED=2]="MOUNTED",t[t.REACTION=3]="REACTION",t))(u||{});const i=class V{constructor(){g(this,"Schema",null),g(this,"key","x-request"),g(this,"createReaction",(a,l={},c)=>(f,C)=>{const F=this.Schema.compile(a,C),T=l.debug||F.debug,N=f.address.entire,L=this.createLogger(!!T,typeof N=="string"?N:"reg-exp address",l.onLog);L.group("Reaction Called");const{format:Z,mountLoad:q=!0,ready:$,onSuccess:J,onError:X,disabledReactive:H}=F,G=(0,o.LO)(F),Q=()=>typeof F.customService=="function"?F.customService(F,l):typeof F.service=="function"?F.service(F.params):O((()=>{try{const b=l.params||{};let B=U(F.params);const W=U(F.staticParams),K=Object.assign({},b,W,B);return Object.assign({},l,F,{params:K})}catch(b){return L.error("Error merging params",b),{}}})()),z=(...b)=>{const[B,...W]=b;if(typeof B=="function")try{B(...W)}catch(K){L.error(`invoke ${B} function failed`,K)}},j=()=>E(this,null,function*(){var b,B;try{if(L.info("Preparing to make request, checking conditions"),typeof $=="boolean"&&!$){L.info("ready field is false, request aborted");return}if(typeof $=="function"&&!$(F)){L.info("ready function returned false, request aborted");return}f.loading=!0,L.info("Making request",{request:F});const W=yield Q(),K=(B=(b=o.aD).bound)==null?void 0:B.call(b,()=>{L.info("Request successful, preparing to set dataSource",{format:Z}),f.dataSource=this.formatData(W,Z),L.info("DataSource set, calling onSuccess"),z(J,W,F)});K&&K()}catch(W){L.error("Failed to set dataSource, calling onError",W),z(X,W)}finally{f.loading=!1}});f.mounted&&(c.lifecycle>u.MOUNTED&&!H&&(L.info(`${this.key} config modified, triggering request`,{lifecycle:u[c.lifecycle]}),j()),c.lifecycle<u.MOUNTED&&(c.lifecycle=u.MOUNTED,L.info("Component mounted",{lifecycle:u[c.lifecycle]}),q&&(L.info("Auto-triggering request after component mount",{mountLoad:q,request:F}),j()),c.lifecycle++)),typeof c.dispose=="function"&&c.dispose(),c.dispose=(0,o.N7)(G,b=>{L.info(`Manual ${this.key} config change, triggering request`,{change:b}),j()}),f.inject({updateRequest:b=>{L.info("Calling updateRequest");try{if(typeof b!="function")throw new Error("updateRequest parameter must be a function");b(G)}catch(B){L.error("updateRequest failed",B)}},reloadRequest:()=>(L.info("Manual reloadRequest call, triggering request",{request:F}),j())}),f.unmounted&&(typeof c.dispose=="function"&&(c.dispose(),c.dispose=null),c.lifecycle=u.UNMOUNT,L.info("Component unmounted",{unmounted:f.unmounted})),L.groupEnd()})}static getInstance(){return this._instance||(this._instance=new V),this._instance}use(a){if(!a)throw new Error("\u8BF7\u4F20\u5165Schema\u914D\u7F6E");if(!("registerPatches"in a))throw new Error('Schema\u7F3A\u5C11"registerPatches"\u65B9\u6CD5');if(!("compile"in a))throw new Error('Schema\u7F3A\u5C11"compile"\u65B9\u6CD5');return this.Schema=a,this}register(...a){try{if(!this.Schema)throw new Error('formily-request\u7F3A\u5C11Schema\uFF0C\u8BF7\u5148\u4F7F\u7528"use"\u51FD\u6570\u6CE8\u5165Schema');let l={};if(a.length===1){const[f]=a;typeof f=="string"?this.key=f:l=f}else if(a.length===2){const[f,C]=a;this.key=f,l=C}this.key.startsWith("x-")||console.warn("\u5B57\u6BB5\u6CA1\u6709\u4F7F\u7528x-\u5F00\u5934",{key:this.key});const c=`${this.key}-registered`;this.Schema.registerPatches(f=>{const C=f[this.key];if(typeof C=="object"&&!f[c]){const F={lifecycle:u.INIT,dispose:null};S(f,"x-compile-omitted",this.key);const T=this.createReaction(C,l,F);S(f,"x-reactions",T),f[c]=!0}return f})}catch(l){console.error("register error",{key:this.key,error:l})}}formatData(a,l){try{if(typeof l=="undefined")return a;if(typeof l!="function")throw new TypeError("format is not a function");let c=l(a);if(!Array.isArray(c))throw new Error(`format must return an array, but got ${typeof c}`);return c}catch(c){const f=_(c);throw new Error(`format error: ${f}`,{cause:c})}}createLogger(a,l,c){return new y(a,l?`${this.key}:${l}`:"",c)}};g(i,"_instance",null);const d=i.getInstance()}}]);
