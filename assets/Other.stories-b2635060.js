import{D as l}from"./index-380d6ecd.js";import"./jsx-runtime-f7703cfb.js";import"./index-2d6a15d9.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-ab15b175.js";import"../sb-preview/runtime.js";import"./isNativeReflectConstruct-8ef081c8.js";const v={title:"Example/Other",component:l,parameters:{},argTypes:{schema:{control:"object"}}},e={name:"radio",args:{schema:{type:"object",properties:{radio:{type:"string",title:"Radio","x-decorator":"FormItem","x-component":"Radio.Group","x-request":{customService:"{{ customJsonp }}",url:"https://apis.map.qq.com/ws/place/v1/suggestion",params:{keyword:"经海路"},format:"{{ (res) => res?.data.map(item => ({label: item.title, value: item.id})) || [] }}"}}}}}},r={name:"checkbox",args:{schema:{type:"object",properties:{radio:{type:"string",title:"Radio","x-decorator":"FormItem","x-component":"Checkbox.Group","x-request":{customService:"{{ customJsonp }}",url:"https://apis.map.qq.com/ws/place/v1/suggestion",params:{keyword:"经海路"},format:"{{ (res) => res?.data.map(item => ({label: item.title, value: item.id})) || [] }}"}}}}}},t={name:"cascader",args:{schema:{type:"object",properties:{cascader:{type:"string",title:"级联下拉","x-decorator":"FormItem","x-component":"Cascader","x-component-props":{style:{width:300},placeholder:"请选择下拉项"},"x-request":{service:"{{ queryCascader }}",silent:!1}}}}}};var o,a,s;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  name: "radio",
  args: {
    schema: {
      type: "object",
...
//# sourceMappingURL=Other.stories-b2635060.js.map
